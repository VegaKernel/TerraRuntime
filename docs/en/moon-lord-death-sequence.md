...
These verify individual authoritative head AI calls and projectile creation. Continuous encounter behavior, Good World boulders, Moon Leech AI/buff/healing-blob interactions, all multiplayer targeting arrangements, retired visual rotation and True Eye attacks remain open.