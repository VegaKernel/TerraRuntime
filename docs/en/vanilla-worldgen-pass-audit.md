...
| 44 | Pyramids | Dungeon | P | selection closed by 32 official complete-delegate fixtures on both pinned builds; `WorldGen.Pyramid` interior blocked on the unported `AddBuriedChest` |
