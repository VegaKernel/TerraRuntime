...
Liquid contact is derived by TerraRuntime from authoritative world tiles; the host still supplies no liquid or velocity data. The verified ordinary unmounted path now preserves the vanilla previous/current contact ordering: the previous tick's contact selects gravity, effective terminal fall speed and jump profile, while the current contact selects collision displacement and becomes the next tick's profile state. Effective max-fall clamps are $10.01$ dry, $5.01$ in ordinary water/lava and $3.01$ in honey; shimmer contact keeps $10.01$. Jump speed/height are $5.01/15$ dry, $6.01/30$ in water/lava, $5.01/15$ in honey and $5.51/23$ in shimmer. Current-contact displacement factors remain $0.5$ in water/lava, $0.25$ in honey and $0.375$ in shimmer. Floating equipment/flippers, merman/trident movement, mounts, grapples, wings/extra jumps, shimmer transformation, drowning and lava damage remain separate work. See [Authoritative player physics](player-physics.md) for the execution graph and transition rules.
