...
The 35 item definitions admit world-drop dimensions and natural-prefix families only. Independent official-server comparisons match 3500 item/seed prefix outcomes and subsequent RNG draws; Venus Magnum and Heat Ray retain their item-specific rounding exclusions. Dropping these items does not admit unverified weapon/tool/accessory use. Global luck/coin/heart rules, bag contents and Temple Key packet 52 unlocking remain explicit progression debts. Neither these rewards nor the existing boss AI slices prove a complete vanilla playthrough.
