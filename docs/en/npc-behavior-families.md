...
- `VanillaBatNpcBehaviorStrategy` owns the ordinary AI_014 bat slice for Cave, Jungle, Hell, Giant, Illuminant, Ice and Lava Bat, Giant Flying Fox and Spore Bat. Their pinned definitions and source-ordered motion cover collision rebound, closest-target refresh, the Hellbat correction constants, wet escape and the pursuit/wander clocks; runtime targeting supplies live wet state and line of sight. Projectile-shooting AI_014 variants and the Vampire Bat transformation remain fail-closed rather than inheriting this bounded profile.
