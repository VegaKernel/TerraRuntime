...
Ordinary peaceful NPC actors and future shop integration remain on the existing NPC authority/UI foundation; removing hostile operator bots does not remove those generic contracts.
