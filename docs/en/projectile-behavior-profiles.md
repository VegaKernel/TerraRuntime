...
The runtime still fails closed on the important missing pieces: full weapon/ammo/provenance coverage beyond the admitted families, other controlled/channeled families such as legacy Flying Knife, yoyos and holdouts, complete mana modifier/refill authority, unsupported multishot/special spawn parameters and explosive projectile families, the remaining vanilla projectile AI families, remaining local/static immunity variants, exceptional hitboxes/target rules, explosive self-hurt/owner-hit semantics, projectile-applied buffs/debuffs, unsupported object-destruction side effects, and exact same-pass child/on-hit spawn ordering. Client packet-27 generations outside the strict source-backed catalog therefore remain synchronization/diagnostic state rather than authoritative combat or terrain sources.
