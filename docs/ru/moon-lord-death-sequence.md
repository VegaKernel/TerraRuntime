...
Подтверждены отдельные синтетические вызовы AI с одной неподвижной целью. Полный непрерывный бой, взаимодействие с прикреплённой взрывчаткой, более широкое мультиплеерное наведение и внешнее движение NPC/снарядов остаются отдельной работой по паритету.
