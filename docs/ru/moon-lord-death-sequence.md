...
Остальные правила иммунитета и экипировки, лечащие сгустки, доказательства фиксации пакета 27 и полная приёмка ещё не завершены. Это не полный паритет Moon Leech или общей системы баффов.
