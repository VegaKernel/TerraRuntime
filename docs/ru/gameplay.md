...
State 6 Sun Dance ????????? 6 ????? ? Classic ? 8 ? Expert ??? ??????? ??????; ??? ????? ?? ??????? ?? ?????? ????.

State 7 ?????? ????????? ????? ???????? ????????? lance-wall, ????? ???? $3200\,\text{????????}$, cadence Expert/?????? ? source predictive aim blend $75\%$. Classic float-loop $1/13$ ????????? 14 ?????; Expert-loop $1/18$ ????????????? ?????????? ??????? ? ????????? 18.

State 11 direct lance ????????? ???????? ???? ?????? $2400\,\text{????????}$. State 12 ?????????? ? ????????????? ????? ??????? $(0,-20)$ ? ???????????? ??? ? $50$-tick firing window; Expert/?????? ?????????? cadence $4$ ticks, Classic ? $6$, ?????????? ?? ????.

????????? Empress 4, 5, 6 ? 7 ????????? source total durations $120$, $72$, $300$ ? Classic/Expert $260/280$ ticks ?? phase/Expert reductions.

Empress movement state 4 ?????????? source target offset $(0,-350)$; state 6 ? $(-80,-500)$.
