...
Vega ? ?????????? ?????? ????? ??????????? `IRuntime.PacketRateLimits` (`IPacketRateLimitControl`). ???? ??????? ???????????? ????????? ??? **???? ??????? ? ??????? ??????????** ????? ?????????? ????????; ?????? ?????????? ?????? ??????????? ???????? ??? ??????? ID ??????. ?????????????? ???????? ??????????? (????? ? ??????), ? ?? ????????? ???????? ????????. ?????????????? ??????????????? ??? ??????? ???.

```csharp
runtime.PacketRateLimits.SetLimit(12, 50); // ?????? ??????????: ????? 12, 50 ???????/?
int? configured = runtime.PacketRateLimits.GetLimit(12);
runtime.PacketRateLimits.SetLimit(12, null); // ??????? ????????????? ?????
```

`SetLimit` ????????? ????? ID ?????? ???? byte ? ????????????? ????? ??????? ? ???????; ???? ? ????????????? ???????? ???????? `ArgumentOutOfRangeException`. `GetLimit` ?????????? `null`, ???? ????????????? ????? ?? ?????. ?????????? ??? ????????????? ?????? ???????????. ???????????? ????????? ? ????????? ??? ????? ??????? ??????????? `HardAbuse` ?????????? ???????? ??????????: ?????????? ??? ???????? ?????????????? ?????? ?? ????????? ??? ??????.

???? ?????????? ????????????? ???? ?? $1\,\mathrm{s}$ ??? ??????? ??????????. ????? $50\,\text{???????/?}$ ???? ?????? ?????? ??????????? ?????? $50\,\text{???????/????}$ ??? ????? ID. ?????? ID ????? ????????? ????????. ??? ??????????? ?? ????????????? ?????, ? ?? ?????????? ???? ??? ??????????? ????????: ???????? ?? ??? ??????? ??????? ???? ????? ???? ??????.

????????? ???????????????; ??????? ?????????? ?????? ?? ??? ????????? ???????. ????????? ?????? ??? ??? ???????? ? ????????? ????????? ?? ?????????? ?????? ???????? ????; ?????? ??? ????????? ?????? ???? ???????????. ????? ?????????? ???????? ????? ????????. ??????? ????? ?????? ?????? ???????? ????????? ???????? ?????? ? ????? ????????? ????????. ???????????? ???????? ????? 256 ???????, ?????? ?????????? ? ????? 256 ?????????; ????????? ??????? ???????? ?? ??????? ???.

????? ???????? ??????????? ? `TerrariaConnectionPolicySink` ?? ???????? ? gameplay ? ????????? ???????????? ????????? ???????. ?????????? ??????????? ?????????? ?????????? ?? ??????; ?????? ?????????? ??????????? ? ???????? `RateLimited`. ?????? ?????? `PlayerControls` ??-???????? ????????????? ??? ??????????, ??? ???? ?????????? ?????????? ????????? ?????? ???????? ?????????. ???????? ?????? ???? ??? ???????????? ??????? ????????? ?? ?????????? ?????? ????? ID. ???????? ?????? ?????? ????????, ?? ???????????? ????????? ?????????.

?????????? ????????, ????????? ????????? ? ??????????/?????????????? ????? ??????????? ??????????? Vega. API runtime ???????? ??????????? ?????; ??? ????????? ?? ??????? ?????? Vega ??? ???????? ???????? ?????????. ????????? ??????? ???????, ??????????? packet-48 ? ??????? ????????? ???????? ?? ????????.
