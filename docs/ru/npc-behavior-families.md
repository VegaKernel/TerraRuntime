...
- `VanillaBatNpcBehaviorStrategy` владеет обычным срезом AI_014 для Cave, Jungle, Hell, Giant, Illuminant, Ice и Lava Bat, Giant Flying Fox и Spore Bat. Их закреплённые definitions и source-ordered движение покрывают отскок при столкновении, обновление ближайшей цели, отдельные коэффициенты Hellbat, выход из жидкости и pursuit/wander clocks; runtime targeting передаёт актуальные wet-state и line of sight. Стреляющие варианты AI_014 и превращение Vampire Bat остаются fail-closed и не наследуют этот ограниченный профиль.
