...
AI_077/078/079 source review also admits the represented explicit `netUpdate` calls into `INpcAiForcedUpdateIntentPlanner`: Core initialization, intro/teleport completion and shell exposure; non-retired Hand and Head attack-table transitions; and Head's elapsed-180 Deathray launch. A direct regression covers every positive handoff and ordinary/retired negatives. No generic Moon Lord motion or unrepresented source effect is made urgent.
