...
- [ ] Complete vanilla projectile AI families. `BasicArrow`, `Thrown`, source-backed Enchanted Boomerang type 6, launcher `Bomb` aiStyle-16 types 133..144, controlled aiStyle-9 Magic Missile/Flamelash/Rainbow Rod, the admitted Skeletron/Deerclops families and other existing source-backed slices remain explicit profiles. The server-owned hostile slice now also covers straight no-gravity AI_001 beams for Wall of Flesh/Probe/Retinazer/Golem (83/84/100/259), Plantera Seed/Poison Seed (275/276), Plantera Thorn Ball (277), Golem Fireball (258), Skeletron Prime Bomb (102), Phantasmal Eye/Sphere/Deathray (452/454/455), Hallow Boss Rainbow Streak (873), and Fairy Queen Lance/Sun Dance (919/923). Runtime lifecycle owns server-only `Projectile.localAI[0..2]`; released Phantasmal Sphere dynamically uses two subupdates, Phantasmal Deathray owns aiStyle-84 anchoring plus three-sample tile-scanned beam length and line collision, Rainbow Streak owns AI_171 drift/homing, and Empress line attacks use source line-hitbox/damage-gate semantics. The NPC-side Moon Lord transition that releases already-spawned spheres is still a separate cross-entity side-effect gap. Known unsupported families still fail closed.
