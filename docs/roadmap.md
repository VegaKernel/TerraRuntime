...
2026-09-15 Prime ranged arms: source AI35/36 movement, target handoff, rotation, shot clocks and orphan removal now execute with committed RNG/projectile effects. Original Windows/Linux matrices cover 3,456 baseline + 6,912 geometry/target calls, 96 eight-call sequences and 60 parent cases per platform. Laser100 physical size is corrected to 7x7 after source scaling. Focused 10,590 tests and CoreCLR protocol smoke pass; negative controls and full/native acceptance are being finalized. Melee arms, full encounters and remaining gameplay/network parity stay open. See [NPC ownership](en/npc-runtime-ownership.md).
