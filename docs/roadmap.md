...
2026-09-20 Mechdusa Probe attachment: AI_005 now applies the live Destroyer hitbox/rotation/velocity and source `26 × ai[3]` orbit with invulnerability. Its timer is three updates per tick, reaches 360, and fires the speed-8, target-velocity-leading pink laser from the pre-attachment snapped source center. Focused regressions cover the orbit, state, boundary and projectile. Missing-anchor recovery, other combined AI and encounter parity remain open.
