...
Full-playthrough continuation (2026-09-20): Plantera and Golem route NPC-specific Classic/Expert/Master death rewards through the existing authoritative combat and world-item/instanced-loot owners. Packet 52 action 2 now has an inbound owner: it consumes the first ordinary-inventory Temple Key1141, validates and unlocks the source three-row door footprint, echoes packet52 to other peers and sends the source 2x2 tile square. Focused wire, ingress, inventory-order, tile and replication regressions pass. This does **not** close end-to-end progression: Void Bag key fallback, bag opening, complete item/weapon/projectile semantics, global loot/luck, remaining boss rewards and full dungeon/worldgen parity remain open. See [death-loot scope](en/gameplay.md#plantera-and-golem-death-rewards).
