...
The sandbox roadmap has moved to the dedicated [`sandbox/`](sandbox/README.md) directory.
...
- [English sandbox architecture](../en/sandbox/README.md);
- [Русская архитектура sandbox](../ru/sandbox/README.md).

The old path is intentionally retained as a stable entry point for existing links.
