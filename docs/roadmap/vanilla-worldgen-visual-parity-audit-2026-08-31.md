...
- [ ] Underworld terrain/initial lava basin/QuickWater/ore runner equality and special-seed ash vegetation; implemented structures/lighting/furniture/decorations/ordinary forests and two-row lava restoration are not full Underworld parity.
- [ ] dungeon furniture/locked and biome chests/traps and reference-seed equality; the existing graph checkbox below is not full dungeon parity.
