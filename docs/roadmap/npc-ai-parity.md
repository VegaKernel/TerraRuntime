...
2026-09-14 departure slice: Moon Lord state3 now performs source cleanup at40/60, removes attacks with packet27 followed by silent removal, clears/persists LunarApocalypseIsUp without victory or loot, and requests immediate world-info. Direct original-AI fixtures, a full executor lifecycle, live WorldRuntime broadcast, original-header/whole-world reloads and negative controls cover this behavior. Mounted players remain in the shared NPC candidate list. Intro, teleport, shared RNG consumption, complete encounter/event behavior and full AI parity remain open; see the bilingual [lifecycle contract](../en/moon-lord-death-sequence.md).

2026-09-14 persistence correction: the already wired Fishron, Cultist, Empress and Moon Lord victory milestones now survive the checkpoint header patch; previously the writer rejected them as unsupported mutations. All256 baseline/mutation combinations match independently emitted official headers. Five loaded lunar-event flags survive prepared-cache restoration; layout3 rejects old2. Live lunar-event transitions and encounter completion remain open.
