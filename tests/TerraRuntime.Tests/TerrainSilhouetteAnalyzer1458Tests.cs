...
public sealed class VanillaTerrainSilhouetteAnalyzer1458Tests
{
    ...
    public void Capture_ignores_isolated_solid_foreground_and_uses_supported_ground()
    {
        ...
        TerrainSilhouette1458 silhouette =
            TerrainSilhouetteAnalyzer1458.Capture(store, bucketCount: 4);
    ...
    public void Compare_reports_column_error_bucket_error_correlation_and_variation()
    {
        ...
        TerrainSilhouette1458 reference =
            TerrainSilhouetteAnalyzer1458.Capture(referenceStore, bucketCount: 4);
        TerrainSilhouette1458 candidate =
            TerrainSilhouetteAnalyzer1458.Capture(candidateStore, bucketCount: 4);

        TerrainSilhouetteComparison1458 comparison =
            TerrainSilhouetteAnalyzer1458.Compare(reference, candidate);
