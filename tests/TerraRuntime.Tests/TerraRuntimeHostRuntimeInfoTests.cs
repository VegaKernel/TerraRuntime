...
public sealed class TerraRuntimeHostRuntimeInfoTests
{
    [Fact]
    public void Existing_host_constructor_produces_assigned_in_process_persistent_identity()
    {
        var info = new TerraRuntimeHostRuntimeInfo(
            "Primary",
            "Worlds/primary.wld",
            4200,
            1200,
    ...
    {
        var first = new TerraRuntimeHostRuntimeInfo("Arena", "", 640, 240, 0, 8);
        var second = new TerraRuntimeHostRuntimeInfo("Arena", "", 640, 240, 0, 8);
    ...
    {
        var info = new TerraRuntimeHostRuntimeInfo("Arena", "", 640, 240, 0, 8)
        {
