...
public sealed class RuntimeWorldGenerationCandidateServiceTests
{
    [Fact]
    public void Selected_generator_builds_isolated_candidate()
    {
        ...
        var service = new RuntimeWorldGenerationCandidateService(new TestSource(provider));
    ...
    public void Unknown_generator_never_allocates_a_publishable_candidate()
    {
        ...
        var service = new RuntimeWorldGenerationCandidateService(new TestSource(new TestProvider(registered)));
