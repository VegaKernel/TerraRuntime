...
public sealed class SourceBackedVanillaWorldGenerationJungleStructures1458Tests
{
    [Fact]
    public void Canonical_ordinary_world_extends_source_order_from_dirt_rock_walls_through_first_liquid_settle()
    {
        var provider = new SourceBackedVanillaWorldGenerationJungleStructures1458();
        ...
        Assert.IsType<VanillaSourceBackedBiomesCompatibilityBarrier1458>(biomes.Pass);
        ...
        Assert.Contains(
            SourceBackedVanillaWorldGenerationJungleStructures1458.SettleLiquidsId,
    ...
    public void Noncanonical_world_keeps_existing_compatibility_plan_unchanged()
    {
        ...
        Assert.DoesNotContain(builder.Entries, static entry =>
            entry.Descriptor.Id == SourceBackedVanillaWorldGenerationJungleStructures1458.JungleTempleId);
        Assert.DoesNotContain(builder.Entries, static entry =>
