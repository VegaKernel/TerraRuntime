...
public sealed class RuntimeWorldCheckpointSnapshotSourceTests
{
    ...
    public void Snapshot_waits_for_tile_bootstrap_and_detaches_tiles_and_chests_from_later_mutation()
    {
        ...
        var source = new RuntimeWorldCheckpointSnapshotSource(
            tiles,
            chestStore,
        ...
        Assert.True(source.TryCapture(out RuntimeWorldCheckpointSnapshot? current));
    ...
    public void Snapshot_detaches_live_town_npc_and_room_state_for_world_save()
    {
        ...
        var town = new RuntimeTownNpcStateStore(
            ...
            dimensions);
        var source = new RuntimeWorldCheckpointSnapshotSource(tiles, chestStore, 4, townNpcStore: town);
