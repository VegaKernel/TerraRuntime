...
public sealed class SourceBackedVanillaWorldGenerationLateStructures1458Tests
{
    [Fact]
    public void Canonical_ordinary_world_extends_source_order_through_floating_island_houses()
    {
        var provider = new SourceBackedVanillaWorldGenerationLateStructures1458();
        ...
        Assert.Contains(
            SourceBackedVanillaWorldGenerationLateStructures1458.FloatingIslandHousesId,
    ...
    public void Noncanonical_world_keeps_existing_compatibility_plan_unchanged()
    {
        ...
        Assert.DoesNotContain(builder.Entries, static entry =>
            entry.Descriptor.Id == SourceBackedVanillaWorldGenerationLateStructures1458.SpiderCavesId);
        Assert.DoesNotContain(builder.Entries, static entry =>
