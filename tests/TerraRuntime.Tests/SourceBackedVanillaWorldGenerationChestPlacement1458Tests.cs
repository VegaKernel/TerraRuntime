...
public sealed class SourceBackedVanillaWorldGenerationChestPlacement1458Tests
{
    [Fact]
    public void Canonical_ordinary_world_extends_source_order_through_water_chests()
    {
        var provider = new SourceBackedVanillaWorldGenerationChestPlacement1458();
        ...
        Assert.Contains(SourceBackedVanillaWorldGenerationChestPlacement1458.WaterChestsId, secrets.Descriptor.RequiredAfter.ToArray());
    }
    ...
    {
        var workspace = new RuntimeWorldGenerationWorkspace(32, 24);
    ...
    public void Noncanonical_world_keeps_existing_compatibility_plan_unchanged()
    {
        ...
        Assert.DoesNotContain(builder.Entries, static entry =>
            entry.Descriptor.Id == SourceBackedVanillaWorldGenerationChestPlacement1458.BuriedChestsId);
        Assert.DoesNotContain(builder.Entries, static entry =>
            entry.Descriptor.Id == SourceBackedVanillaWorldGenerationChestPlacement1458.WaterChestsId);
    }
