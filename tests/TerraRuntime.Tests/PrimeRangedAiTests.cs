...
{
    private static readonly JsonElement[] BaseRows = OperatingSystem.IsWindows()
        ? Read("PrimeRangedAiWindows1458", "8ee324aa8db975e5067c844cfc54fb6d7064eecb8f2df31a353f69bcd6393267")
        : Read("PrimeRangedAiLinux1458", "3e775739dde0684c27be0e41ec0cd7ca4080ba0cb12883c69ce42582c9adb61e");
    private static readonly JsonElement[] Orphans = OperatingSystem.IsWindows()
        ? Read("PrimeRangedParentWindows1458", "b25f7185d4f5a3602507a8eff3a31e7a1495df142c17bee3e0f2b7d5e5638b48")
        : Read("PrimeRangedParentLinux1458", "a831454e61eac0ad934f64b545163deef05df2077f067d19cbd03551201a67de");
    private static readonly JsonElement[] Rows = BaseRows.Concat(OperatingSystem.IsWindows()
        ? Read("PrimeRangedGeometryWindows1458", "bfcc490b26a3f244a14b58f89ae9af8c8496a9cfcc50b1b7b2277a4dbde9b67a")
        : Read("PrimeRangedGeometryLinux1458", "cf33bada81374f0c8e6d3b2f81fabcfa1b9407bee584cdc61560b162ce8f3269")).Concat(Orphans).ToArray();
    private static readonly JsonElement[] Traces = OperatingSystem.IsWindows()
        ? Read("PrimeRangedTraceWindows1458", "7d3d396818890df9d75f658486329120d547be49303b71cc4edd21e9be925d94")
        : Read("PrimeRangedTraceLinux1458", "6b6f0f58cb64362b707345baca8baadf5de35ff51cf1c8c38c0a0b8f3ccdfbe1");
    public static TheoryData<int> Cases => new(Enumerable.Range(0, Rows.Length));

    [Theory]
    [MemberData(nameof(Cases))]
    public void Ranged_arm_state_projectiles_and_rng_match_original(int index)
    {
        var row = Rows[index];
    ...
    {
        using var resource = typeof(PrimeRangedAiTests).Assembly.GetManifestResourceStream(name)!;
