...
public sealed class SkeletronDeathProgressionTests
{
    [Fact]
    public void Progression_header_patcher_sets_downed_boss3_and_keeps_world_loadable()
    {
        ...
        Assert.False(source.RuntimeMetadata.DownedBoss3);
        ...
        Assert.True(mutations.MarkCompleted(VanillaWorldProgressionId.Skeletron));
        ...
        Assert.True(loaded.RuntimeMetadata.DownedBoss3);
        Assert.Equal(source.RuntimeMetadata.DownedBoss1, loaded.RuntimeMetadata.DownedBoss1);
        Assert.Equal(source.RuntimeMetadata.DownedBoss2, loaded.RuntimeMetadata.DownedBoss2);
