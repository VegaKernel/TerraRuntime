...
public sealed class ProjectileVanillaCombatFactsTests
{
    [Theory]
    ...
    {
        Assert.True(VanillaCombatFacts.TryGetDamageClass(new ProjectileTypeId(type), out VanillaProjectileDamageClass actual));
    ...
    public void Pve_ranged_hit_uses_ranged_crit_damage_variance_and_generic_armor_penetration()
    {
        ...
        Assert.True(VanillaCombatFacts.TryResolvePveHit(
    ...
    public void Pvp_ranged_projectile_does_not_roll_ranged_crit_but_melee_projectile_can_crit()
    {
        ...
        Assert.True(VanillaCombatFacts.TryResolvePvpHit(
