...
/// </summary>
public sealed class SourceBackedVanillaWorldGenerationUndergroundFinish1458 : IWorldGenerationProvider
{
    ...
    private readonly SourceBackedVanillaWorldGenerationVegetation1458 baseline = new();
    ...
    public void BuildPlan(in WorldGenerationRequest request, IWorldGenerationPlanBuilder builder)
    {
        ...
        var state = new VanillaUndergroundFinishWorldGenerationState1458();
        foreach (CapturedPass entry in capture.Entries)
        {
            ...
            Add(builder, GemsInIceBiomeId, SourceBackedVanillaWorldGenerationVegetation1458.MushroomsId,
                new VanillaUndergroundFinishWorldGenerationPass1458(VanillaUndergroundFinishWorldGenerationStage1458.GemsInIceBiome, state));
            Add(builder, RandomGemsId, GemsInIceBiomeId,
                new VanillaUndergroundFinishWorldGenerationPass1458(VanillaUndergroundFinishWorldGenerationStage1458.RandomGems, state));
            Add(builder, MossGrassId, RandomGemsId,
                new VanillaUndergroundFinishWorldGenerationPass1458(VanillaUndergroundFinishWorldGenerationStage1458.MossGrass, state));
            Add(builder, MudsWallsInJungleId, MossGrassId,
                new VanillaUndergroundFinishWorldGenerationPass1458(VanillaUndergroundFinishWorldGenerationStage1458.MudsWallsInJungle, state));
            Add(builder, LarvaId, MudsWallsInJungleId,
                new VanillaUndergroundFinishWorldGenerationPass1458(VanillaUndergroundFinishWorldGenerationStage1458.Larva, state));
...
internal enum VanillaUndergroundFinishWorldGenerationStage1458 : byte
{
    GemsInIceBiome,
    RandomGems,
    MossGrass,
...
internal sealed class VanillaUndergroundFinishWorldGenerationState1458
{
...
internal sealed class VanillaUndergroundFinishWorldGenerationPass1458 : IWorldGenerationPass
{
    ...
    private readonly VanillaUndergroundFinishWorldGenerationStage1458 stage;
    private readonly VanillaUndergroundFinishWorldGenerationState1458 state;

    public VanillaUndergroundFinishWorldGenerationPass1458(
        VanillaUndergroundFinishWorldGenerationStage1458 stage,
        VanillaUndergroundFinishWorldGenerationState1458 state)
    {
        this.stage = stage;
        this.state = state;
    }
    ...
    public void Execute(IWorldGenerationContext context)
    {
        ...
        RuntimeWorldGenerationWorkspace workspace = context.Workspace as RuntimeWorldGenerationWorkspace ??
            throw new InvalidOperationException("Underground-finish generation requires RuntimeWorldGenerationWorkspace.");
        ...
        switch (stage)
        {
            case VanillaUndergroundFinishWorldGenerationStage1458.GemsInIceBiome:
                ApplyGemsInIceBiome(context, grid, random);
                break;
            case VanillaUndergroundFinishWorldGenerationStage1458.RandomGems:
                ApplyRandomGems(context, grid, random);
                break;
            case VanillaUndergroundFinishWorldGenerationStage1458.MossGrass:
                ApplyMossGrass(context, grid, random);
                break;
            case VanillaUndergroundFinishWorldGenerationStage1458.MudsWallsInJungle:
                ApplyMudsWallsInJungle(context, grid, random);
                break;
            case VanillaUndergroundFinishWorldGenerationStage1458.Larva:
