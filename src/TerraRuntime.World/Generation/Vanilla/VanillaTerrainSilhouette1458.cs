...
/// </summary>
internal sealed record VanillaTerrainSilhouette1458(
    int Width,
    int Height,
...
internal sealed record VanillaTerrainSilhouetteComparison1458(
...
internal static class VanillaTerrainSilhouetteAnalyzer1458
{
        ...
        int bucketCount = DefaultBucketCount)
    {
        ...
        return new VanillaTerrainSilhouette1458(
            width,
            height,
            surface,
    ...
    public static VanillaTerrainSilhouetteComparison1458 Compare(
        ...
        VanillaTerrainSilhouette1458 candidate)
    {
        ...
        return new VanillaTerrainSilhouetteComparison1458(
            meanAbsoluteError,
            rootMeanSquareError,
            percentile95Error,
            maximumError,
