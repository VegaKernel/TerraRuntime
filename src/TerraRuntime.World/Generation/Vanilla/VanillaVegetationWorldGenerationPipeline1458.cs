...
/// </summary>
public sealed class SourceBackedVanillaWorldGenerationVegetation1458 : IWorldGenerationProvider
{
    ...
    private readonly SourceBackedVanillaWorldGenerationStartingNpc1458 baseline = new();
    ...
    public void BuildPlan(in WorldGenerationRequest request, IWorldGenerationPlanBuilder builder)
    {
        ...
        var state = new VanillaVegetationWorldGenerationState1458();
        foreach (CapturedPass entry in capture.Entries)
        {
            ...
            Add(builder, SunflowersId, SourceBackedVanillaWorldGenerationStartingNpc1458.GuideId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.Sunflowers, state));
            Add(builder, PlantingTreesId, SunflowersId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.PlantingTrees, state));
            Add(builder, HerbsId, PlantingTreesId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.Herbs, state));
            Add(builder, DyePlantsId, HerbsId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.DyePlants, state));
            Add(builder, WebsAndHoneyId, DyePlantsId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.WebsAndHoney, state));
            Add(builder, WeedsId, WebsAndHoneyId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.Weeds, state));
            Add(builder, GlowingMushroomsAndJunglePlantsId, WeedsId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.GlowingMushroomsAndJunglePlants, state));
            Add(builder, JunglePlantsId, GlowingMushroomsAndJunglePlantsId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.JunglePlants, state));
            Add(builder, VinesId, JunglePlantsId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.Vines, state));
            Add(builder, FlowersId, VinesId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.Flowers, state));
            Add(builder, MushroomsId, FlowersId,
                new VanillaVegetationWorldGenerationPass1458(VanillaVegetationWorldGenerationStage1458.Mushrooms, state));
...
internal enum VanillaVegetationWorldGenerationStage1458 : byte
{
    Sunflowers,
    PlantingTrees,
    Herbs,
...
internal sealed class VanillaVegetationWorldGenerationState1458
{
...
internal sealed class VanillaVegetationWorldGenerationPass1458 : IWorldGenerationPass
{
    ...
    private readonly VanillaVegetationWorldGenerationStage1458 stage;
    private readonly VanillaVegetationWorldGenerationState1458 state;

    public VanillaVegetationWorldGenerationPass1458(
        VanillaVegetationWorldGenerationStage1458 stage,
        VanillaVegetationWorldGenerationState1458 state)
    {
        this.stage = stage;
        this.state = state;
    }
    ...
    public void Execute(IWorldGenerationContext context)
    {
        ...
        RuntimeWorldGenerationWorkspace workspace = context.Workspace as RuntimeWorldGenerationWorkspace ??
            throw new InvalidOperationException("Vegetation generation requires RuntimeWorldGenerationWorkspace.");
        ...
        switch (stage)
        {
            case VanillaVegetationWorldGenerationStage1458.Sunflowers:
                ApplySunflowers(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.PlantingTrees:
                ApplyPlantingTrees(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.Herbs:
                ApplyHerbs(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.DyePlants:
                ApplyDyePlants(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.WebsAndHoney:
                ApplyWebsAndHoney(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.Weeds:
                ApplyWeeds(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.GlowingMushroomsAndJunglePlants:
                ApplyGlowingMushroomsAndJunglePlants(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.JunglePlants:
                ApplyJunglePlants(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.Vines:
                ApplyVines(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.Flowers:
                ApplyFlowers(context, grid, random);
                break;
            case VanillaVegetationWorldGenerationStage1458.Mushrooms:
