...
/// </summary>
internal static class OptimizedJungleEcologyV2
{
    ...
    internal static OptimizedJungleEcologyV2Report Apply(IWorldGenerationContext context)
    {
        ...
        var report = new OptimizedJungleEcologyV2Report(
...
internal readonly record struct OptimizedJungleEcologyV2Report(
    int HiveTarget,
    int HiveComponents,
    int AddedHives,
