...
internal sealed class BuiltInWorldGeneratorSource : ITerraRuntimeWorldGeneratorSource
{
    ...
    private readonly SourceBackedVanillaWorldGenerationUndergroundFinish1458 vanilla = new();
...
internal sealed class FlatWorldGenerationProvider : IWorldGenerationProvider
{
