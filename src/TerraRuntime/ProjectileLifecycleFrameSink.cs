...
/// applies cheap client-authority guards and queues immutable decoded state. Exact ProjectileKey lookup,
/// physical allocation, ownership validation and mutation are authoritative-thread responsibilities.
/// </summary>
