...
public static class VanillaItemIds
{
    ...
    public static readonly ItemTypeId MeteorHelmet = new(123);
    public static readonly ItemTypeId MeteorSuit = new(124);
    public static readonly ItemTypeId MeteorLeggings = new(125);
    public static readonly ItemTypeId NecroHelmet = new(151);
    public static readonly ItemTypeId NecroBreastplate = new(152);
    public static readonly ItemTypeId NecroGreaves = new(153);
    public static readonly ItemTypeId ShadowGreaves = new(100);
    public static readonly ItemTypeId ShadowScalemail = new(101);
    public static readonly ItemTypeId ShadowHelmet = new(102);
    public static readonly ItemTypeId JungleHat = new(228);
    public static readonly ItemTypeId JungleShirt = new(229);
    public static readonly ItemTypeId JunglePants = new(230);
    public static readonly ItemTypeId MoltenHelmet = new(231);
    public static readonly ItemTypeId MoltenBreastplate = new(232);
    public static readonly ItemTypeId MoltenGreaves = new(233);
    ...
    public static readonly ItemTypeId FeralClaws = new(211);
    public static readonly ItemTypeId TitanGlove = new(536);
    public static readonly ItemTypeId PowerGlove = new(897);
    public static readonly ItemTypeId AvengerEmblem = new(935);
    public static readonly ItemTypeId MechanicalGlove = new(936);
    ...
    public static readonly ItemTypeId MagmaStone = new(1322);
    ...
    public static readonly ItemTypeId CelestialStone = new(1865);
    public static readonly ItemTypeId CelestialEmblem = new(2220);
    public static readonly ItemTypeId PutridScent = new(3015);
    public static readonly ItemTypeId CelestialShell = new(3110);
    public static readonly ItemTypeId BerserkerGlove = new(3992);
    public static readonly ItemTypeId MoltenQuiver = new(4002);
    public static readonly ItemTypeId ReconScope = new(4005);
    public static readonly ItemTypeId StalkersQuiver = new(4006);
    public static readonly ItemTypeId SharkToothNecklace = new(3212);
    public static readonly ItemTypeId FossilHelm = new(3374);
    public static readonly ItemTypeId FossilShirt = new(3375);
    public static readonly ItemTypeId FossilPants = new(3376);
    ...
    public static readonly ItemTypeId MeteorShot = new(234);
    ...
    public static readonly ItemTypeId TinHelmet = new(687);
    public static readonly ItemTypeId TinChainmail = new(688);
    public static readonly ItemTypeId TinGreaves = new(689);
    public static readonly ItemTypeId LeadHelmet = new(690);
    public static readonly ItemTypeId LeadChainmail = new(691);
    public static readonly ItemTypeId LeadGreaves = new(692);
    public static readonly ItemTypeId TungstenHelmet = new(693);
    public static readonly ItemTypeId TungstenChainmail = new(694);
    public static readonly ItemTypeId TungstenGreaves = new(695);
    public static readonly ItemTypeId PlatinumHelmet = new(696);
    public static readonly ItemTypeId PlatinumChainmail = new(697);
    public static readonly ItemTypeId PlatinumGreaves = new(698);
    public static readonly ItemTypeId CrimsonHelmet = new(792);
    public static readonly ItemTypeId CrimsonScalemail = new(793);
    public static readonly ItemTypeId CrimsonGreaves = new(794);
    public static readonly ItemTypeId AncientIronHelmet = new(954);
    public static readonly ItemTypeId AncientGoldHelmet = new(955);
    public static readonly ItemTypeId AncientShadowHelmet = new(956);
    public static readonly ItemTypeId AncientShadowScalemail = new(957);
    public static readonly ItemTypeId AncientShadowGreaves = new(958);
    public static readonly ItemTypeId AncientNecroHelmet = new(959);
    public static readonly ItemTypeId AncientCobaltHelmet = new(960);
    public static readonly ItemTypeId AncientCobaltBreastplate = new(961);
    public static readonly ItemTypeId AncientCobaltLeggings = new(962);
    public static readonly ItemTypeId PumpkinHelmet = new(1731);
    public static readonly ItemTypeId PumpkinBreastplate = new(1732);
    public static readonly ItemTypeId PumpkinLeggings = new(1733);
    public static readonly ItemTypeId GladiatorHelmet = new(3187);
    public static readonly ItemTypeId GladiatorBreastplate = new(3188);
    public static readonly ItemTypeId GladiatorLeggings = new(3189);
