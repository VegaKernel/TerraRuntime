...
public static class VanillaNpcIds
{
    ...
    public static readonly NpcTypeId CorruptGoldfish = new(57);
    public static readonly NpcTypeId Piranha = new(58);
    ...
    public static readonly NpcTypeId GiantBat = new(93);
    ...
    public static readonly NpcTypeId LavaBat = new(151);
    public static readonly NpcTypeId GiantFlyingFox = new(152);
    public static readonly NpcTypeId Arapaima = new(157);
    ...
    public static readonly NpcTypeId BloodFeeder = new(241);
    ...
    public static readonly NpcTypeId CrimsonGoldfish = new(465);
    public static readonly NpcTypeId GoldGoldfish = new(592);
    public static readonly NpcTypeId Pupfish = new(607);
    public static readonly NpcTypeId Dolphin = new(615);
    public static readonly NpcTypeId BloodSquid = new(619);
    public static readonly NpcTypeId EmpressOfLight = new(636);
    public static readonly NpcTypeId SporeBat = new(634);
    public static readonly NpcTypeId QueenSlime = new(657);
    public static readonly NpcTypeId QueenSlimeMinionPurple = new(660);
    public static readonly NpcTypeId Pufferfish = new(688);
    public static readonly NpcTypeId Orca = new(692);
...
public static class VanillaNpcAiStyles
{
    ...
    public static readonly NpcAiStyleId Bat = new(14);
...
public static class VanillaItemIds
{
    ...
    public static readonly ItemTypeId Shuriken = new(42);
    public static readonly ItemTypeId FlintlockPistol = new(95);
    ...
    public static readonly ItemTypeId Bone = new(154);
    public static readonly ItemTypeId Bomb = new(166);
    public static readonly ItemTypeId Dynamite = new(167);
    ...
    public static readonly ItemTypeId GlowingMushroom = new(183);
    public static readonly ItemTypeId HiveBlock = new(1124);
    public static readonly ItemTypeId PiranhaGun = new(1156);
    public static readonly ItemTypeId RainbowGun = new(1260);
    public static readonly ItemTypeId VampireKnives = new(1569);
    public static readonly ItemTypeId ScourgeOfTheCorruptor = new(1571);
    public static readonly ItemTypeId StaffOfTheFrostHydra = new(1572);
    public static readonly ItemTypeId StormTigerStaff = new(4607);
    public static readonly ItemTypeId VineRope = new(2996);
    public static readonly ItemTypeId GuideToPlantFiberCordage = new(3068);
    ...
    public static readonly ItemTypeId TheUndertaker = new(800);
    ...
    public static readonly ItemTypeId RottenEgg = new(1809);
    public static readonly ItemTypeId StarAnise = new(1913);
    public static readonly ItemTypeId GrenadeLauncher = new(758);
    public static readonly ItemTypeId RocketLauncher = new(759);
    public static readonly ItemTypeId ProximityMineLauncher = new(760);
    public static readonly ItemTypeId CelebrationMk2 = new(3930);
    public static readonly ItemTypeId MiniNukeI = new(4457);
    public static readonly ItemTypeId MiniNukeII = new(4458);
    public static readonly ItemTypeId RocketI = new(771);
    public static readonly ItemTypeId RocketII = new(772);
    public static readonly ItemTypeId RocketIII = new(773);
    public static readonly ItemTypeId RocketIV = new(774);
    public static readonly ItemTypeId Revolver = new(2269);
    ...
    public static readonly ItemTypeId VortexPickaxe = new(2776);
    public static readonly ItemTypeId DrillContainmentUnit = new(2768);
    ...
    public static readonly ItemTypeId SoaringInsignia = new(4989);
...
public static class VanillaProjectileIds
{
    ...
    // AI_003 type 243, type 251 and type 350 source projectile identities.
    ...
    public static readonly ProjectileTypeId GrenadeII = new(136);
    public static readonly ProjectileTypeId RocketII = new(137);
    public static readonly ProjectileTypeId ProximityMineII = new(138);
    public static readonly ProjectileTypeId GrenadeIII = new(139);
    public static readonly ProjectileTypeId RocketIII = new(140);
    public static readonly ProjectileTypeId ProximityMineIII = new(141);
    public static readonly ProjectileTypeId GrenadeIV = new(142);
    public static readonly ProjectileTypeId RocketIV = new(143);
    public static readonly ProjectileTypeId ProximityMineIV = new(144);
    ...
    public static readonly ProjectileTypeId StickyDynamite = new(470);
    public static readonly ProjectileTypeId CultistRitual = new(490);
    public static readonly ProjectileTypeId BouncyBomb = new(516);
    public static readonly ProjectileTypeId BouncyDynamite = new(637);
    public static readonly ProjectileTypeId CelebrationMk2HeldProjectile = new(714);
    public static readonly ProjectileTypeId CelebrationRocketI = new(715);
    public static readonly ProjectileTypeId CelebrationRocketII = new(716);
    public static readonly ProjectileTypeId CelebrationRocketIII = new(717);
    public static readonly ProjectileTypeId CelebrationRocketIV = new(718);
    public static readonly ProjectileTypeId ScarabBomb = new(773);
    public static readonly ProjectileTypeId MiniNukeRocketI = new(793);
    public static readonly ProjectileTypeId MiniNukeGrenadeI = new(794);
    public static readonly ProjectileTypeId MiniNukeMineI = new(795);
    public static readonly ProjectileTypeId MiniNukeRocketII = new(796);
    public static readonly ProjectileTypeId MiniNukeGrenadeII = new(797);
    public static readonly ProjectileTypeId MiniNukeMineII = new(798);
    public static readonly ProjectileTypeId MiniNukeSnowmanRocketI = new(808);
    public static readonly ProjectileTypeId MiniNukeSnowmanRocketII = new(809);
    ...
    public static readonly ProjectileTypeId Explosives = new(108);
    ...
    public static readonly ProjectileTypeId SilverBullet = new(981);
...
public static class VanillaTileIds
{
    ...
    public static readonly TileTypeId Torches = new(4);
    ...
    public static readonly TileTypeId Heart = new(12);
    public static readonly TileTypeId Bottles = new(13);
    ...
    public static readonly TileTypeId Demonite = new(22);
    public static readonly TileTypeId CorruptGrass = new(23);
    public static readonly TileTypeId CorruptPlants = new(24);
    public static readonly TileTypeId Pots = new(28);
    ...
    public static readonly TileTypeId Vines = new(52);
    public static readonly TileTypeId Meteorite = new(37);
    public static readonly TileTypeId Chandeliers = new(34);
    public static readonly TileTypeId BlueDungeonBrick = new(41);
    public static readonly TileTypeId HangingLanterns = new(42);
    public static readonly TileTypeId Spikes = new(48);
    public static readonly TileTypeId WaterCandle = new(49);
    public static readonly TileTypeId Banners = new(91);
    public static readonly TileTypeId Books = new(50);
    public static readonly TileTypeId GreenDungeonBrick = new(43);
    public static readonly TileTypeId PinkDungeonBrick = new(44);
    ...
    public static readonly TileTypeId Hellstone = new(58);
    public static readonly TileTypeId Mud = new(59);
    public static readonly TileTypeId JungleGrass = new(60);
    public static readonly TileTypeId JunglePlants = new(61);
    public static readonly TileTypeId JungleVines = new(62);
    ...
    public static readonly TileTypeId Plants2 = new(73);
    public static readonly TileTypeId JunglePlants2 = new(74);
    public static readonly TileTypeId ImmatureHerbs = new(82);
    public static readonly TileTypeId MatureHerbs = new(83);
    public static readonly TileTypeId BloomingHerbs = new(84);
    public static readonly TileTypeId Lamps = new(93);
    public static readonly TileTypeId HallowedPlants = new(110);
    public static readonly TileTypeId Ebonsand = new(112);
    public static readonly TileTypeId HallowedPlants2 = new(113);
    public static readonly TileTypeId Pearlsand = new(116);
    public static readonly TileTypeId Silt = new(123);
    public static readonly TileTypeId LongMoss = new(184);
    public static readonly TileTypeId CrimsonPlants = new(201);
    public static readonly TileTypeId Campfire = new(215);
    public static readonly TileTypeId Slush = new(224);
    public static readonly TileTypeId DyePlants = new(227);
    public static readonly TileTypeId PlantDetritus = new(233);
    public static readonly TileTypeId RollingCactus = new(484);
    public static readonly TileTypeId AntlionLarva = new(485);
    public static readonly TileTypeId Crimsand = new(234);
    public static readonly TileTypeId Painting2X3 = new(245);
    public static readonly TileTypeId Painting3X2 = new(246);
    public static readonly TileTypeId ConveyorBeltLeft = new(421);
    public static readonly TileTypeId ConveyorBeltRight = new(422);
    public static readonly TileTypeId AshPlants = new(637);
    public static readonly TileTypeId JunglePlantsEcho = new(703);
    ...
    public static readonly TileTypeId Cobalt = new(107);
    public static readonly TileTypeId Mythril = new(108);
    public static readonly TileTypeId Adamantite = new(111);
    public static readonly TileTypeId Pearlstone = new(117);
    public static readonly TileTypeId PressurePlates = new(135);
    public static readonly TileTypeId Switches = new(136);
    public static readonly TileTypeId Painting3X3 = new(240);
    public static readonly TileTypeId Painting4X3 = new(241);
    public static readonly TileTypeId Painting6X4 = new(242);
    public static readonly TileTypeId Traps = new(137);
    ...
    public static readonly TileTypeId Crimtane = new(204);
    public static readonly TileTypeId Chlorophyte = new(211);
    public static readonly TileTypeId Palladium = new(221);
    public static readonly TileTypeId Orichalcum = new(222);
    public static readonly TileTypeId Titanium = new(223);
    ...
    public static readonly TileTypeId MysticSnakeRope = new(504);
...
public static class VanillaWallIds
{
    ...
    public static readonly WallTypeId GreenDungeonUnsafe = new(8);
    public static readonly WallTypeId PinkDungeonUnsafe = new(9);
    public static readonly WallTypeId BlueDungeonSlabUnsafe = new(94);
    public static readonly WallTypeId BlueDungeonTileUnsafe = new(95);
    public static readonly WallTypeId PinkDungeonSlabUnsafe = new(96);
    public static readonly WallTypeId PinkDungeonTileUnsafe = new(97);
    public static readonly WallTypeId GreenDungeonSlabUnsafe = new(98);
