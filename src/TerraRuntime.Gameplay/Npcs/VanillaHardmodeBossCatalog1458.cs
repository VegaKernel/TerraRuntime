...
public static class VanillaHardmodeBossCatalog1458
{
    ...
    [
        ...
        Boss(VanillaNpcIds.Golem, VanillaNpcAiStyles.Golem, 140, 140, 72, 26, 15_000,
            physics: VanillaNpcPhysicsFamily.GenericGround),
        Part(VanillaNpcIds.GolemHead, VanillaNpcAiStyles.GolemHead, 70, 70, 64, 20, 25_000, noGravity: true),
        Part(VanillaNpcIds.GolemFistLeft, VanillaNpcAiStyles.GolemFist, 40, 30, 59, 28, 10_000, noGravity: true),
        Part(VanillaNpcIds.GolemFistRight, VanillaNpcAiStyles.GolemFist, 40, 30, 59, 28, 10_000, noGravity: true),
        Part(VanillaNpcIds.GolemHeadFree, VanillaNpcAiStyles.GolemHeadFree, 70, 70, 80, 32, 16_000,
            noGravity: true, dontTakeDamage: true),
        ...
        Part(VanillaNpcIds.PlanteraHook, VanillaNpcAiStyles.PlanteraHook, 40, 40, 60, 24, 4_000,
            noGravity: true, noTileCollide: true, dontTakeDamage: true),
