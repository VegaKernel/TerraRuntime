...
public static class VanillaVultureMotion1458
{
        ...
        else if (!input.CurrentTargetDead)
        {
            ...
            if (input.ClosestTarget.HasTarget)
            {
                ...
                float targetY = input.ClosestTargetCenterY -
                                VanillaPlayerHitboxFacts.BaseHeight * 0.5f -
                                input.Height * 0.5f;
    ...
    {
        float playerLeft = input.ClosestTargetCenterX - VanillaPlayerHitboxFacts.BaseWidth * 0.5f;
        float playerTop = input.ClosestTargetCenterY - VanillaPlayerHitboxFacts.BaseHeight * 0.5f;
        float left = input.PositionX - 100f;
        float top = input.PositionY - 100f;
        float width = input.Width + 200f;
        float height = input.Height + 200f;
        return left < playerLeft + VanillaPlayerHitboxFacts.BaseWidth &&
