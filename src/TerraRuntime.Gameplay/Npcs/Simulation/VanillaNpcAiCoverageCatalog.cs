...
public static class VanillaNpcAiCoverageCatalog
{
    ...
    private static VanillaNpcAiCoverage[] CreateEntries()
    {
        ...
        var entries = new VanillaNpcAiCoverage[
            ...
            VanillaMoonEventGroundFighterCatalog1458.DefinitionCount + 12];
        entries[0] = Partial(
        ...
        foreach (VanillaNpcDefinition definition in VanillaMoonEventGroundFighterCatalog1458.AllDefinitions)
        {
            entries[index++] = Partial(
                definition.Type,
                OrdinaryCore |
        ...
        entries[index++] = Partial(
            VanillaMoonEventSpecialCatalog1458.SnowMoonAi60Santank,
            OrdinaryCore | VanillaNpcAiCapability.MoonEventProjectileSlice);
        entries[index++] = Partial(
            VanillaMoonEventSpecialCatalog1458.SnowMoonAi61IceQueen,
            OrdinaryCore);
        entries[index++] = Partial(
            VanillaMoonEventSpecialCatalog1458.SnowMoonAi62,
            OrdinaryCore | VanillaNpcAiCapability.MoonEventProjectileSlice);
        entries[index++] = Partial(
