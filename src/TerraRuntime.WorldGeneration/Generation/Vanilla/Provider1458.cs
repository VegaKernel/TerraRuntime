...
/// </summary>
public sealed class Provider1458 : IWorldGenerationProvider
{
    ...
    public void BuildPlan(in WorldGenerationRequest request, IWorldGenerationPlanBuilder builder)
    {
        ...
        Add(builder, BiomesId, BiomesPass.Instance, TerrainId);
        Add(builder, CavesId, CavesPass.Instance, BiomesId);
        Add(builder, OresId, OresPass.Instance, CavesId);
        Add(builder, DungeonsId, DungeonPass.Instance, OresId);
        Add(builder, SecretSeedsId, SecretSeedPass.Instance, DungeonsId);
    ...
    private sealed class BiomesPass : IWorldGenerationPass
    {
        public static BiomesPass Instance { get; } = new();
    ...
    private sealed class CavesPass : IWorldGenerationPass
    {
        public static CavesPass Instance { get; } = new();
    ...
    private sealed class OresPass : IWorldGenerationPass
    {
        public static OresPass Instance { get; } = new();
    ...
    private sealed class DungeonPass : IWorldGenerationPass
    {
        public static DungeonPass Instance { get; } = new();
    ...
    private sealed class SecretSeedPass : IWorldGenerationPass
    {
        public static SecretSeedPass Instance { get; } = new();
    ...
    private static VanillaWorldSeedProfile1458 ResolveSeedProfile(IWorldGenerationContext context)
    {
        ...
        return WorldSeedResolver1458.Resolve(in request);
    }
