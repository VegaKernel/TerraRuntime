...
/// </summary>
public sealed class SourceBackedVanillaWorldGenerationPostSettle1458 : IWorldGenerationProvider
{
    ...
    private readonly SourceBackedVanillaWorldGenerationJungleStructures1458 baseline = new();
    ...
    public void BuildPlan(in WorldGenerationRequest request, IWorldGenerationPlanBuilder builder)
    {
        ...
        var state = new VanillaPostSettleWorldGenerationState1458();
        foreach (CapturedPass entry in capture.Entries)
        {
            ...
            Add(builder, RemoveWaterFromSandId, SourceBackedVanillaWorldGenerationJungleStructures1458.SettleLiquidsId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.RemoveWaterFromSand, state));
            Add(builder, OasisId, RemoveWaterFromSandId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.Oasis, state));
            Add(builder, ShellPilesId, OasisId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.ShellPiles, state));
            Add(builder, SmoothWorldId, ShellPilesId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.SmoothWorld, state));
            Add(builder, WaterfallsId, SmoothWorldId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.Waterfalls, state));
            Add(builder, IceId, WaterfallsId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.Ice, state));
            Add(builder, WallVarietyId, IceId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.WallVariety, state));
            Add(builder, LifeCrystalsId, WallVarietyId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.LifeCrystals, state));
            Add(builder, StatuesId, LifeCrystalsId,
                new VanillaPostSettleWorldGenerationPass1458(VanillaPostSettleWorldGenerationStage1458.Statues, state));
...
internal enum VanillaPostSettleWorldGenerationStage1458 : byte
{
    RemoveWaterFromSand,
    Oasis,
    ShellPiles,
...
internal sealed class VanillaPostSettleWorldGenerationState1458
{
...
internal sealed class VanillaPostSettleWorldGenerationPass1458 : IWorldGenerationPass
{
    ...
    private readonly VanillaPostSettleWorldGenerationStage1458 stage;
    private readonly VanillaPostSettleWorldGenerationState1458 state;

    public VanillaPostSettleWorldGenerationPass1458(
        VanillaPostSettleWorldGenerationStage1458 stage,
        VanillaPostSettleWorldGenerationState1458 state)
    {
        this.stage = stage;
        this.state = state;
    }
    ...
    public void Execute(IWorldGenerationContext context)
    {
        ...
        RuntimeWorldGenerationWorkspace workspace = context.Workspace as RuntimeWorldGenerationWorkspace ??
            throw new InvalidOperationException("Post-settle Terraria generation requires RuntimeWorldGenerationWorkspace.");
        ...
        switch (stage)
        {
            case VanillaPostSettleWorldGenerationStage1458.RemoveWaterFromSand:
                ApplyRemoveWaterFromSand(context, grid);
                break;
            case VanillaPostSettleWorldGenerationStage1458.Oasis:
                ApplyOasis(context, grid, random);
                break;
            case VanillaPostSettleWorldGenerationStage1458.ShellPiles:
            ...
            case VanillaPostSettleWorldGenerationStage1458.Waterfalls:
                ...
                break;
            case VanillaPostSettleWorldGenerationStage1458.Ice:
                ApplyIce(context, grid, random);
                break;
            case VanillaPostSettleWorldGenerationStage1458.WallVariety:
                ApplyWallVariety(context, grid, random);
                break;
            case VanillaPostSettleWorldGenerationStage1458.LifeCrystals:
                ApplyLifeCrystals(context, grid, random);
                break;
            case VanillaPostSettleWorldGenerationStage1458.Statues:
