...
/// <summary>
/// Production playability overlay for <see cref="OptimizedProvider"/>. The baseline owns the major
...
/// </summary>
public sealed class PlayableProvider : IWorldGenerationProvider
{
    ...
    private readonly OptimizedProvider baseline = new();
    ...
    private sealed class PlayabilityValidationPass(FeatureState state) : IWorldGenerationPass
    {
        public void Execute(IWorldGenerationContext context)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Optimized playability validation requires Workspace.");
            }
