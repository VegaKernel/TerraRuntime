...
/// </summary>
public sealed class ProgressionContentProvider : IWorldGenerationProvider
{
    ...
    private readonly LandmarkProvider baseline = new();
    ...
    private sealed class ProgressionContentPass : IWorldGenerationPass
    {
        ...
        {
            HiveComponentPlacement[] components = JungleEcologyV2.CaptureHiveComponents(context.Workspace)
        ...
        private static int PlaceLarvaInComponent(
            IWorldGenerationWorkspace workspace,
            JungleEcologyV2.HiveComponent component,
            int maximum,
            bool skipExisting = false)
        {
            ...
            {
                if (!JungleEcologyV2.CanHostLarva(workspace, x, y))
                    continue;
