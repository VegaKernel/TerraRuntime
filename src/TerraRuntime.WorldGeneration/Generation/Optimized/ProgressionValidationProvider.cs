...
/// </summary>
public sealed class ProgressionValidationProvider : IWorldGenerationProvider
{
    ...
    private sealed class ProgressionValidationPass : IWorldGenerationPass
    {
        ...
        public void Execute(IWorldGenerationContext context)
        {
            ...
            ProgressionValidationReport report =
                ProgressionWorldValidator.Validate(
                    context.Workspace,
                    metadata,
                    in request,
...
/// </summary>
public readonly record struct ProgressionValidationReport(
    int CopperTiles,
    int IronTiles,
    int SilverTiles,
    int GoldTiles,
...
/// </summary>
public static class ProgressionWorldValidator
{
        ...
        ScanResult scan)
    {
        ...
        RequireMinimum("Obsidian", scan.ObsidianTiles, ProgressionContentProvider.ResolveObsidianTarget(workspace.WidthTiles));
    }
        ...
        ScanResult scan)
    {
        ...
        RequireMinimum(
            ...
            scan.EvilAnchorObjects,
            ProgressionContentProvider.ResolveEvilAnchorTarget(workspace.WidthTiles));
        RequireMinimum(
            "Larva objects",
            scan.LarvaObjects,
            ProgressionContentProvider.ResolveLarvaTarget(workspace.WidthTiles));
        RequireMinimum(
