...
internal sealed class DashboardWorkspaceWindow : Runnable
{
    ...
    private void RefreshNetwork()
    {
        ...
        var lines = new List<string>(20)
        {
            ...
            $"Liquid      sent {snapshot.EmittedLiquidUpdates:N0}  pending {snapshot.PendingLiquidUpdates:N0}  coalesced {snapshot.CoalescedLiquidUpdates:N0}  evicted {snapshot.DroppedLiquidUpdates:N0}",
