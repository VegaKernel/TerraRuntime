...
/// </summary>
internal sealed class TerminalUiWorldInspectionCache : IRuntimeWorldInspectionOperations
{
    ...
    public TerminalUiWorldInspectionCache(IRuntimeWorldInspectionOperations source)
    {
