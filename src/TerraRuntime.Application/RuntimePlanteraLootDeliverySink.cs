...
/// <summary>Production world-item and addressed Boss Bag delivery for the Plantera death-loot slice.</summary>
internal sealed class RuntimePlanteraLootDeliverySink : IPlanteraLootDeliverySink
{
    ...
    public RuntimePlanteraLootDeliverySink(
