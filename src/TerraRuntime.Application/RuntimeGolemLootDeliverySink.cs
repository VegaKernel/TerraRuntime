...
/// <summary>Production world-item and addressed Boss Bag delivery for the Golem death-loot slice.</summary>
internal sealed class RuntimeGolemLootDeliverySink : IGolemLootDeliverySink
{
    ...
    public RuntimeGolemLootDeliverySink(
