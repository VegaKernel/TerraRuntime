...
/// <summary>Production world-item and addressed Boss Bag delivery for the MoonLord death-loot slice.</summary>
internal sealed class RuntimeMoonLordLootDeliverySink : IMoonLordLootDeliverySink
{
    ...
    public RuntimeMoonLordLootDeliverySink(
