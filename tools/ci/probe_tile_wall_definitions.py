...
def main() -> int:
    ...
    require_constant(tile_id, "DemonAltar", 26)
    require_constant(tile_id, "Cobweb", 51)
    require_constant(tile_id, "Sand", 53)
    require_constant(tile_id, "Mud", 59)
    require_constant(tile_id, "JungleGrass", 60)
    require_constant(tile_id, "MushroomGrass", 70)
    require_constant(tile_id, "Hellforge", 77)
    ...
    require_constant(tile_id, "Hive", 225)
    require_constant(tile_id, "LihzahrdBrick", 226)
    require_constant(tile_id, "LihzahrdAltar", 237)
    require_constant(tile_id, "Marble", 367)
    require_constant(tile_id, "Granite", 368)
    ...
    require_constant(wall_id, "SpiderUnsafe", 62)
    require_constant(wall_id, "HiveUnsafe", 86)
    require_constant(wall_id, "LihzahrdBrickUnsafe", 87)
    ...
    print("skyblock_progression_tile_ids=26,51,70,77,225,226,237,367,368")
    print("skyblock_progression_wall_ids=62,86,87")
